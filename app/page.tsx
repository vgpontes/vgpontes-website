  ...
  return (
    <>
      <main className="min-h-screen">
        <article className="divide-y divide-solid divide-light-gray mx-4 sm:mx-10 md:mx-24 lg:mx-28">
          <section id="intro" className="flex h-svh items-center justify-center">
            <div className="flex flex-col justify-center text-wrap text-center text-white items-center space-y-5 md:space-y-10">
              ...
              <p className="text-lg md:text-2xl max-w-3xl font-sans-400">{content.headerText}</p>
            </div>
          </section>
          <section id="aboutme" className="flex justify-center items-center">
            <div className="flex lg:h-auto flex-col lg:flex-row justify-center items-center text-white py-10 lg:py-20 lg:space-x-20 space-y-5">
              <div className="relative rounded-full grow-0 shrink-0 w-52 h-52 md:w-72 md:h-72 lg:h-80 lg:w-80 overflow-hidden">
                <Image className="object-cover" fill src="/images/victor-face.jpg" alt="Victor Pontes"/>
              </div>
              <div className="text-wrap">
                <h1 className="text-center lg:text-left text-2xl lg:text-3xl font-mono-700 lg:mb-11 mb-5">/about_me</h1>
                <p className="text-md text-justify max-w-3xl l:pr-20 font-sans-300 whitespace-pre-line">{content.aboutMe}</p>
              </div>
            </div>
          </section>
          <section id="experience" className="flex flex-col justify-center items-center py-10 lg:py-20 xl:px-20">
          ...
          <section id="certifications" className="flex flex-col justify-center items-center p-10 lg:p-20">
            <h1 className="text-2xl lg:text-3xl font-mono-700 mb-11 text-white">/certifications</h1>
            <Badge/>
          </section>
        </article>
        <footer id="contact" className="relative flex flex-col h-52 bg-dark-blue justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-4">
            <h2 className="text-white text-xl md:text-2xl font-mono-700">CONTACT ME</h2>
          ...
          <div className="absolute bottom-0 mb-4">
              <p className="text-light-gray text-sm md:text-lg font-mono-700">Made with love in Seattle, WA</p>
          </div>
        </footer>
    </main>
    </>
