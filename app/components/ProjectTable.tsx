    ...
    return (
        <div id="project-table" className="flex flex-col justify-top text-white h-full w-full xl:px-20">
            <div id="title-section" className="flex justify-center text-white border border-light-gray rounded-t-lg w-full">
                <h1 className="text-2xl lg:text-3xl font-mono-700 my-3">/projects</h1>
            </div>
            <div id="bottom-section" className="lg:flex lg:flex-row border-x border-b border-light-gray overflow-auto h-full rounded-b-lg">
                        ...
                        {projects.map((project) => 
                            <li key={`${project.projectTitle}`} className='inline-block lg:block mb-4 lg:mb-0 w-full'>
                                <button disabled={selectedProject == project} onClick={() => setSelectedProject(project)} className={`${selectedProject == project ? 'text-white' : 'text-light-gray hover:text-light-blue'} 
                                    snap-center lg:snap-align-none lg:block text-nowrap lg:text-wrap text-left font-mono-700 uppercase text-sm text-light-gray transition hover:duration-500`}>
                ...
                <div id="project-details" className="flex flex-col w-full p-6 items-end">
                    ...
                    <div className="flex flex-col space-y-4 h-full w-full lg:px-16 pt-4">
                        <h1 className='font-sans-700 text-xl lg:text-2xl uppercase w-full'>
                            {selectedProject.projectTitle}
                        </h1>
                        <h2 className='font-sans-700 text-md lg:text-lg w-full'>
